...
public class BoardVO {
	...
	public String toString() {
		return "BoardVO [no=" + no + ", title=" + title + ", content=" + content + ", count=" + count + ", writeDate="
				+ writeDate + ", memberVO=" + memberVO + ", orgfilename=" + orgfilename + ", newfilename=" + newfilename
