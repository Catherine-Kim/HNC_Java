...
public class DownloadView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> map, 
		...
		String path = (String) map.get("path");		// Map에 저장된 path
		String fileName = request.getParameter("filename");	// request에 binding된 filename
		System.out.println("filename from DownloadView :: " + fileName);
