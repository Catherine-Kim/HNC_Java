...
public class MemberController extends MultiActionController {
	...
	public ModelAndView idcheck(HttpServletRequest request, HttpServletResponse response) 
																		throws Exception {
		return new ModelAndView("idcheck", "flag", 
