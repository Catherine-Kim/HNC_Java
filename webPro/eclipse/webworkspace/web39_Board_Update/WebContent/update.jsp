...
<tr>
	<td>
		<table width="550">
			<tr>
				<td>
				<b>글번호 : <input type="text" name="no" value="${bvo.no}" readonly="readonly"> |
				   타이틀 : <input type="text" name="title" value="${bvo.title}"></b>
			...
			<textarea rows="15" cols="75" name="content"> ${bvo.content}
			</textarea></td></tr>
