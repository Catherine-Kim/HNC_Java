...
<script type="text/javascript">
	function winOpen(type) {
		// delete_popup.jsp 새 창을 띄운다.
		window.open(type + "_popup.jsp?no=${bvo.no}", "", "resizable=true,"
				+ " toolbar=no, width=300, height=200");
	}
</script>
</head>
<body>
	...
	<td>
		<table width="550">
			...
			<tr>
				...
				<img alt="삭제" src="img/delete_btn.jpg" border="0" onclick="winOpen('delete')">
				<img alt="수정" src="img/modify_btn.jpg" border="0" onclick="winOpen('update')">
				</td>			
			</tr>
		</table>
	</td>
