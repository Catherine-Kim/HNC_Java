...
public class EducationServiceTest {
	public static void main(String[] args) {
		...
		// Student(int ssn, String name, int age, String address, MyDate birthday, int stuID)
		...
		// Teacher(int ssn, String name, int age, String address, MyDate birthday, String subject)
		...
		// Employee(int ssn, String name, int age, String address, MyDate birthday, String dept)
